  ...
  <div class="dateIndex">
    ...
    <div class="dateCont">
      <ul class="weekdays">
        ...
        <li>四</li>
        <li>五</li>
        <li style="color:orangered">六</li>
        <li style="color: orangered">日</li>
      </ul>
      <ul class="days">
...
export default {
  ...
  methods: {
    ...
    // 手动设置，加班或者国假
    getRest (dat) {
      let restList = [{ y: 2017, m: 11, d: 30, rest: 1 }, { y: 2017, m: 11, d: 31, rest: 1 }, {
        y: 2018,
        m: 0,
        d: 1,
        rest: 1
      }, { y: 2018, m: 8, d: 24, rest: 1 }, { y: 2018, m: 8, d: 29, rest: 2 }, {
        y: 2018,
        m: 8,
        d: 30,
        rest: 2
      }, { y: 2018, m: 9, d: 1, rest: 1 }, { y: 2018, m: 9, d: 2, rest: 1 }, {
        y: 2018,
        m: 9,
        d: 3,
        rest: 1
      }, { y: 2018, m: 9, d: 4, rest: 1 }, { y: 2018, m: 9, d: 5, rest: 1 }, {
        y: 2018,
        m: 9,
        d: 6,
        rest: 1
      }, { y: 2018, m: 9, d: 7, rest: 1 }]
      let lab = false
